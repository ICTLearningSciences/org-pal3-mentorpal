...
mentor.videoURLFor = function(id) {
	return `${MENTOR_VIDEO_HOST}/videos/mentors/${mentorID}/${id}${mobileSuffix}.mp4`
}
mentor.idleURL = mentor.videoURLFor('idle')
...
video.onended = function(){		//when the video playing finishes, play the idle video
	video.src = mentor.idleURL + mobileSuffix + ".mp4";
