...
class TestCLI(unittest.TestCase):
    ...
    def testsubscribe(self):
        ...
        cli = StompCLI(
            host, port, username, password, "1.0", stdin=teststdin, stdout=teststdout
        )
    ...
    def testabort(self):
        ...
        teststdout.expect(
            'Subscribing to "/queue/testabort" with acknowledge set to "auto", id set to "1"'
        )
