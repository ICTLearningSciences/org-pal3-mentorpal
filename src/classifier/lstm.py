...
class TopicLSTM(object):
    ...
    def read_training_data(self):
        self.train_data=json.load(open(os.path.join("mentors",self.mentor.id,"train_data","lstm_train_data.json"),'r'))
        self.test_data=json.load(open(os.path.join("mentors",self.mentor.id,"test_data","lstm_test_data.json"),'r'))
