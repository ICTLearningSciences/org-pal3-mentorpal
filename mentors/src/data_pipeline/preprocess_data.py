...
for this script is pipeline_entrypoint.py. This script takes as input, a directory
of raw mentor files, i.e. a video.mp4, audio.wav and timestamp.csv file for each
part of each session for a mentor. This script will return chunked audiofiles that
cut any quiet time or mistakes made during recording. This script will also return
any transcripts generated by our transcript service.
"""
